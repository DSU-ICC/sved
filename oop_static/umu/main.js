document.addEventListener("DOMContentLoaded", function() {
    ...
    const getRemovableDisciplines = async (statusDisciplineId, el) => {
        ...
        let response = await fetch(`https://oop.dgu.ru/api/Discipline/GetRemovableDisciplines?userId=${userId}`, {
            credentials: "include"
        })
    ...
    const deleteDiscipline = async (disciplineId, el) => {
        ...
        let response = await fetch(`https://oop.dgu.ru/api/Discipline/DeleteDiscipline?disciplineId=${disciplineId}`, {
            method: "POST",
            credentials: "include"
        })
    ...
    const deleteStatusDiscipline = async (statusDisciplineId, el) => {
        ...
        let response = await fetch(`https://oop.dgu.ru/api/StatusDiscipline/DeleteStatusDiscipline?statusDisciplineId=${statusDisciplineId}`, {
            method: "POST",
            credentials: "include"
        })
