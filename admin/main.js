document.addEventListener("DOMContentLoaded", () => {
    ...
    const fileTypes = {
        ...
        10: "Рабочая программа практики",
        4: "ГИА",
        6: "Матрица компетенции",
        11: "Методический материал"
    }
    ...
    const fillDataForUploadFile = (targetItem) => {
        ...
        modalUploadFile.querySelector(".popup-form__input").setAttribute("placeholder", fileTypes[fileTypeId])
    ...
    //отображение пользователю всех профилей с названиями их факультетов
   ...
   getProfilesById().then(_ => getCaseSDepartments()).then(_ => getLevelEdues()).then(_ => getEduForms())
})